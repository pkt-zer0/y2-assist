...
export const bot1: BotDefinition = {
    normal: [
        { minHand: 5, maxHand: 6, choices: [
                ...
                mProjectile( 8, 7, { description: 'X', blockDamage: 4 }),
                mProjectile( 8, 7, { description: 'X', blockDamage: 4 }),
            ] },
        ...
        { minHand: 9, maxHand: 10, choices: [
                ...
                BLOCK_HIGH,
                BLOCK_LOW,
                mThrow (18, 5, { description: 't → CD',  adjust: -2, firstDamage: 7, knockdown: false }),
                mThrow (18, 5, { description: 't → CD',  adjust: -2, firstDamage: 7, knockdown: false }),
        ...
        { minHand: 11, maxHand: 12, choices: [
                mDodge (30,     { description: '2',       adjust: -2, always: true, super: true }),
                mDodge (7,      { description: 'd → t',   adjust: -1, knockdown: true }),
                mThrow (20, 5,  { description: 't → DE',  adjust: -2, firstDamage: 7, knockdown: false }),
                mThrow (20, 5,  { description: 't → DE',  adjust: -2, firstDamage: 7, knockdown: false }),
                mStrike(20, 8,  { description: 'A → BCX', adjust: -3, firstDamage: 3, height: StrikeHeight.Low }),
                mStrike(10, 11, { description: 'Y', blockDamage: 2, unsafe: true }),
                mStrike(20, 15, { description: '1', blockDamage: 1, adjust: -2, always: true, unsafe: true, super: true }),
                mStrike(20, 15, { description: '1', blockDamage: 1, adjust: -2, always: true, unsafe: true, super: true }),
            ] },
    ],
    knockdown: [
